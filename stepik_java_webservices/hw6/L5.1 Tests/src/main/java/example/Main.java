...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ResourceServerI resourceServer = new ResourceServer(new TestResource("Test", 11));
...
//        context.addServlet(new ServletHolder(new AdminPageServlet(accountServer)), AdminPageServlet.ADMIN_URL);
        context.addServlet(new ServletHolder(new ResourcePageServlet(resourceServer)), ResourcePageServlet.RESOURCE_URL);
